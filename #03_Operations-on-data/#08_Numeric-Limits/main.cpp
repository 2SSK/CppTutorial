...
int main() {
  ...
  cout << "The range for unsigned short is from "
  ...
  cout << "The range for unsigned int is from "
  ...
  cout << "The range(with lowest) for float is from "
       << numeric_limits<float>::lowest() << " to "
       << numeric_limits<float>::max() << endl;

  cout << "The range(with lowest) for double is from "
       << numeric_limits<double>::lowest() << " to "
       << numeric_limits<double>::max() << endl;

  cout << "The range(with lowest) for long double is from "
       << numeric_limits<long double>::lowest() << " to "
       << numeric_limits<long double>::max() << endl;

  cout << boolalpha << "int is signed : " << numeric_limits<int>::is_signed
       << endl;
